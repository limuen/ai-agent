...
const demos = [
  {
    ...
    title: "System health",
    description:
      "Validate grouped GET health route and shared response envelope.",
  },
  {
  ...
  },
  {
    ...
    title: "Catalog list",
    description:
      "Validate catalog domain route organization and list response.",
  },
  {
    href: "/verify/user/profile",
    title: "User profile",
    description:
      "Validate user domain route organization and profile response.",
  },
  {
    href: "/verify/order/detail",
    title: "Order detail",
    description:
      "Validate order domain route organization and POST detail lookup.",
  },
  {
    href: "/verify/client/system/ping",
    title: "Client ping demo",
    description:
      "Validate direct browser-to-API access from a client component with NEXT_PUBLIC_API_BASE_URL.",
  },
];
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <p className="max-w-3xl text-base leading-7 text-muted-foreground md:text-lg">
            Each page below validates one grouped API route, and each request is
            managed in its own api.ts file.
          </p>
        </div>
      </section>
        ...
        {demos.map((demo) => (
          ...
          >
            <div className="space-y-3">
              ...
              <span className="inline-flex text-sm font-medium text-foreground">
                Open page →
              </span>
            </div>
          </Link>
